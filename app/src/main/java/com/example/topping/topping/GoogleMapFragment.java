...
public class GoogleMapFragment extends Fragment implements OnMapReadyCallback, GoogleMap.OnInfoWindowClickListener {
    ...
    // 기본위치와 기본 카메라 줌 설정
    private final LatLng mDefaultLocation = new LatLng(37.39444, 126.95556);
        ...
        /*mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoContents(Marker marker) {
                View infoWindow = getLayoutInflater().inflate(R.layout.custom_info_contents,
                        (FrameLayout) findViewById(R.id.fragmentHere), false);

                TextView title = ((TextView) infoWindow.findViewById(R.id.titleC));
                    ...
                    (new OnCompleteListener<PlaceLikelihoodBufferResponse>() {
                        ...
                        public void onComplete(@NonNull Task<PlaceLikelihoodBufferResponse> task) {
                            if (task.isSuccessful() && task.getResult() != null) {
                                ...
                                // 메모리 누수를 방지하기 위해 버퍼 객체가 필요하지 않은 경우, 버퍼의 해당 객체를 해제
        ...
        DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                mMap.addMarker(new MarkerOptions()
                        ...
                        .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)).zIndex(1.0f));
...
//            String s = pos.replace("lat/lng:(","");
//            String s2 = s.replace(")","");
//            Uri uri = Uri.parse(String.format("geo:%s?z=12",s2 ));

        Toast.makeText(getContext(), "우측하단의 아이콘에서 정보를 확인하세요.",
